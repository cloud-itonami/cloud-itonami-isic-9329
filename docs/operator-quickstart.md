# Operator Quickstart — Other amusement and recreation activities n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 9329** (`cloud-itonami-isic-9329`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9329.git
cd cloud-itonami-isic-9329
```
...
- Blueprint governor key: `recreation-safety-governor`
- Likely source path: `recreation.governor.cljc`
